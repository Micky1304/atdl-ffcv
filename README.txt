...
First, the SplitDataset notebook is responsible to split the large satellite image into smaller parts and convert them into the beton format. Additionally, the dataset spanning 200 GB is created and transformed there.
All visualizations are created in the Visualizations.ipynb and those used in the thesis are contrained in the folder "Visualizations"
...
Notebooks for the comparison of CephFS and SSD storage can be found in the folder "3.3_SSD" as well as "3.5_CPU/Loading"
